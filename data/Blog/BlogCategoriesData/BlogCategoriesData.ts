...
export const BlogCategoriesData: IBlogCategory[] = [
  {
    ...
    blogPosts: Array.from({ length: 12 }, (_, index) => ({
      ...
      isHighlight: index % 3 === 0, // Destacar cada 3 artículos
      ...
      blogCategory: {
        ...
        description: "Estrategias y herramientas para atraer nuevos clientes a tu negocio.",
        blogPosts: [],
        createdAt: "2025-02-19T19:34:30.140Z",
        updatedAt: "2025-02-19T19:34:30.140Z",
        deletedAt: null,
      },
      ...
      content: [
        {
          ...
          list: [`Paso 1 de estrategia ${index + 1}`, `Paso 2 de estrategia ${index + 1}`, `Paso 3 de estrategia ${index + 1}`],
        },
      ],
      createdAt: "2025-02-19T19:34:30.140Z",
      updatedAt: "2025-02-19T19:34:30.140Z",
      ...
      content: [
        {
          ...
          list: [`Concepto clave de técnica ${index + 1}`, `Ejemplo de aplicación`, `Mejores prácticas`],
        },
      ],
      createdAt: "2025-02-19T19:34:30.140Z",
      updatedAt: "2025-02-19T19:34:30.140Z",
      ...
      content: [
        {
          ...
          list: [`Estrategia 1 del método ${index + 1}`, `Estrategia 2`, `Casos de éxito`],
        },
      ],
      createdAt: "2025-02-19T19:34:30.140Z",
      updatedAt: "2025-02-19T19:34:30.140Z",
