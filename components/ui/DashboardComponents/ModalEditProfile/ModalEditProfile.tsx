  ...
  return (
    <AnimatePresence mode="wait" onExitComplete={handleCloseEditMenu}>
      {isVisible && (
        ...
        >
          <div className="min-w-[95%] max-w-[95%] h-[80%] rounded-lg border-t-[10px] border-primaryColor bg-bgColor shadow-md absolute top-1/2 left-1/2 z-50 -translate-x-1/2 -translate-y-1/2 overflow-auto dark:bg-secondaryColor sm:min-w-[600px] sm:max-w-[600px] md:min-w-[700px] md:max-w-[700px]">
            <Formik
              initialValues={{
