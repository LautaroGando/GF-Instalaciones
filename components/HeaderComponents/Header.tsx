...
export const Header: React.FC = () => {
  ...
  return (
    <header
      id="main-header"
      className={clsx(
        "w-full flex justify-center transition-all duration-500 items-center text-letterColorLight h-[60px] px-[12px] fixed top-0 z-50 sm:px-[20px] sm:h-[70px] lg:h-[80px]",
        pathname !== "/" &&
