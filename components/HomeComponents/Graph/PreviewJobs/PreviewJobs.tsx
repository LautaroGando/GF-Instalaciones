...
export const PreviewJobs: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-[390px] mx-auto h-60 border-b-[6px] border-primaryColor rounded-tl-[50px] rounded-br-[50px] overflow-hidden relative sm:max-w-[480px] sm:h-72 lg:flex-1 lg:h-[385px] xl:min-w-[580px] xl:h-[425px]">
