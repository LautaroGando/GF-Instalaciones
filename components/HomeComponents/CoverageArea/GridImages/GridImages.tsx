    ...
    <div className="flex gap-2 justify-center md:w-[309px] md:min-w-[309px] lg:min-w-[371px] xl:min-w-[500px]">
      <div className="flex flex-col gap-2 justify-center">
        <Image
          ...
          className="w-[110px] h-[150px] rounded-tl-3xl rounded-br-3xl sm:w-[130px] md:min-w-[120px] sm:h-[174px] lg:w-[150px] lg:h-[200px] xl:w-[180px] xl:h-[250px]"
          priority
        />
        <Image
          src={coverage2}
      ...
      <Image
        ...
        className="w-[173px] h-[320px] rounded-tl-3xl rounded-br-3xl sm:w-[200px] sm:h-[365px] md:max-w-[180px] lg:w-[230px] lg:max-w-[230px] lg:h-[420px] xl:w-[300px] xl:max-w-[300px] xl:h-[510px]"
        priority
      />
    </div>
  );
