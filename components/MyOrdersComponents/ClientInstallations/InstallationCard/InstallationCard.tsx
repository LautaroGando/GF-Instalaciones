...
const InstallationCard: React.FC<IInstallationCardProps> = ({ styles, installation }) => {
  ...
  return (
    <div
      className="relative rounded-2xl border-t-4 bg-white p-6 pb-10 rounded-br-none shadow-md transition-all duration-500 hover:shadow-[0_4px_8px_rgba(0,0,0,0.12)] dark:bg-gray-900 group"
